...
const Testemonial = ()=>{
    ...
    return (
        <div className="h-[640px] pt-10 sm:pt-16 bg-[url(lake.jpg)] bg-fixed bg-cover">
            ...
            <h1 className="mb-10 text-3xl font-medium text-white"> OUR GUEST <span className="text-white">EXPERIENCE</span></h1> 
                <Slider {...settings}>
                    {
                                ...
                                <div key={data.id} className="bg-black/70 p-3 ">
                                    ...
                                    <div>
                                        <p className="mb-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                                            Aspernatur non tempora explicabo, ab nostrum, facilis enim praesentium cumque deserunt repellat saepe minima porro laboriosam amet sint dolore dolorum optio? Autem.
                                        </p>
                                    </div>
                                    <div>
