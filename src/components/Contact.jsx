      ...
      <div className="w-full h-[400px] flex justify-center items-center bg-[url(/lake.jpg)] brightness-90 bg-cover">
        <div className="w-[95%] sm:w-[60%] text-yellow-500">
          ...
          <p>
            ...
            error autem laborum quia ducimus. Voluptates maiores nemo dolorum
            veritatis! Nostrum aperiam iure eligendi quasi explicabo itaque
            architecto. Omnis, ut. Possimus.
          </p>
        </div>
      </div>
